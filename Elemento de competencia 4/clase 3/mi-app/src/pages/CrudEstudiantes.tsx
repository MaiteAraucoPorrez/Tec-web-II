...
import {getEstudiantes,createEstudiante,updateEstudiante,deleteEstudiante,type Estudiante,} from "../services/crudEstudianteService";
...
function CrudEstudiantes() {
  ...
  const validar = () => {
    ...
    if (!edad || edad <= 0) nuevosErrores.edad = "La edad debe ser mayor a 0";
  ...
  return (
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {errores.nombres && <><br /><span style={{color:"red"}}>{errores.nombres}</span></>}
        <br /><br />
        <input type="text" placeholder="Carrera" value={carrera} onChange={(e)=>setCarrera(e.target.value)} />
        {errores.carrera && <><br /><span style={{color:"red"}}>{errores.carrera}</span></>}
        <br /><br />
        <input type="email" placeholder="Correo" value={correo} onChange={(e)=>setCorreo(e.target.value)} />
        {errores.correo && <><br /><span style={{color:"red"}}>{errores.correo}</span></>}
        <br /><br />
        <input type="number" placeholder="Edad" value={edad} onChange={(e)=>setEdad(Number(e.target.value))} />
        {errores.edad && <><br /><span style={{color:"red"}}>{errores.edad}</span></>}
        <br /><br />
