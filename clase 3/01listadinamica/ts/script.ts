...
// DOM
const input = document.getElementById("inputProducto") as HTMLInputElement;
const inputCantidad = document.getElementById("inputCantidad") as HTMLInputElement;
...
const totalVenta = document.getElementById("totalVenta") as HTMLParagraphElement;
...
function render(): void {
  ...
  productos.forEach((prod, index) => {
    ...
    let btnEliminar = li.querySelector(".btnEliminar") as HTMLButtonElement;
...
// Eliminar producto
function eliminarProducto(indice: number): void {
